     ...
     <div className=' flex items-center justify-between p-2 bg-white '>
        <div className=' flex items-center gap-2 sm:gap-1'>
            <div className=' cursor-pointer grid items-center ' onClick={onCartToggle}>
                <ChevronDoubleLeftIcon className=' w-5 h-5 sm:w-4 sm:h-4 text-slate-900  hover:text-orange-500'/>
            </div>
            <div className=''>
        ...
        <div className='grid items-center ' onClick={onCartToggle}>
            <button className='bg-theme-cart text-slate-100 p-0.5 rounded-sm shadow shadow-slate-900 active:scale-90'> <XMarkIcon className=' w-5 h-5 sm:w-4 sm:h-4'></XMarkIcon> </button>
        </div>
     </div>   
    </>
  )
