      ...
      top-0 left-0 right-0 h-[9vh]  md:h-[8vh] opacity-100 z-50 blur-effect-theme flex justify-center`}>
        <nav className=" nike-container flex justify-between items-center">
          ...
          <button
              ...
              className=" relative transition-all duration-300 active:scale-110 border-none outline-none"
            >
              <ShoppingBagIcon
                className={`icon-style sm:h-6 sm:w-6 ${
                  navState && " text-slate-900 transition-all duration-300"
                }`}
              />
              <div
                className={`absolute top-4 sm:top-3 -right-1 w-5 h-5  rounded-full 
                 text-[0.75rem] sm:text-[0.65rem] flex items-center justify-center cursor-pointer transition-all duration-300 hover:scale-110  ${
                   navState
