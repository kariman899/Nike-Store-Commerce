      ...
      <div className="relative h-auto w-auto flex flex-col">
        ...
        <div className=" z-20 nike-container grid items-center justify-items-center">
          <div className=" pt-20 md:pt-16 grid justify-items-center ">
            <h1 className=" text-6xl lg:text-5xl md:text-4xl sm:text-3xl xsm:text-2xl font-extrabold  drop-shadow-sm text-slate-200">{title}</h1>
         ...
         {/**/}
          <div className="">
            ...
            md:h-[32vh]  xsm:h-[18vh] transitions-theme rotate-[-25deg] hover:rotate-0  " />
          </div>
        </div>
      </div>
    </>
